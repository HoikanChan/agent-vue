<template>
    <div class="category">
        <div class="search">
            <input type="text" placeholder="搜索商品" @click="search"/><span @click="shop">取消</span>
        </div> 
        <div class="wrap" v-if="goods">
            <ul class="category_nav" id="category_nav">
                <li class="active"><router-link to="/category/all">全部</router-link></li>
                <li><router-link to="/category/skin">护肤</router-link></li>
                <li><router-link to="/category/beauty">美妆</router-link></li>
                <li><router-link to="/category/perfume">香水</router-link></li>
            </ul>
        </div>
        ...
        <div class="search_goods" v-else="goods">
